...
onMounted(() => {
  let friendId = route.query.data
  http.get(cons.getFriendsPersonalMoments_apis, {
    params: {
      friendId: friendId
    }
  }).then((res) => {
    ...
    ElMessage({
      message: 'Welcome to ' + momentsInfo[0].postName + '‘s personal homepage!',
      type: 'success'
    })
