...
<template>
  <el-container style="height: 40px;width: 100%;flex-direction: column;background-color: whitesmoke">
    <el-row style="height: 60px;width: 100%;padding: 20px 20px 20px;">
      <el-text style="font-size: 15px;font-weight: bold">Emotional Progress Bar</el-text>
    </el-row>
        ...
        <a href="#" class="recommend_a"
          ...
          <el-container style="flex-direction: column;justify-content: center">
            ...
            <div class="demo-progress">
              ...
              />
              <el-image
                  v-if="item.intimacy === '100'"
                  style="height: 25px;width: 25px;position: absolute;bottom: 10px;left: 280px"
                  src="https://s1.aigei.com/prevfiles/f38f43f4528540389e7f61e5e0b2be7b.gif?e=1735488000&token=P7S2Xpzfz11vAkASLTkfHN7Fw-oOZBecqeJaxypL:O3RDKObpByRD3m4TMTrIFk5Khe0="
              ></el-image>
            </div>
          </el-container>
        </a>
